...
func _get_round_text() -> String:
	var starting_text = "" if Globals.current_round != 1 else "What a beautiful morning. It's 9:00am, 
		the sun is shining, you've got a full cup of coffee, and ... oh no ... its Friday and you've slacked 
		off on your writing all week!!! You have 10 poems that you need to submit by the end of the day. 
		That gives you 90 minutes to write each poem.\nBetter get to it!\n
		------------------------------------------------------\n\n"
